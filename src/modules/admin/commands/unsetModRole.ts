...
export const unsetModRoleCommand: SlashCommand = {
  data: new SlashCommandBuilder()
    .setName("unset-mod-role")
    .setDescription("Unset the configured Mod role.")
    ...
    try {
      ...
      await interaction.editReply({
        content: result.deletedRoleId
          ? `Mod role unset and deleted (<@&${result.deletedRoleId}>).`
          : "Mod role unset. The Discord role was left in the server.",
      });
      return;
    } catch (error) {
